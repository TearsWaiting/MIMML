...
def main(lr=0.005, maml_lr=0.01, iterations=1000, ways=5, shots=5, tps=32, fas=5, device=torch.device("cpu"),
         download_location="../data/task_data/text"):
    dataset = l2l.text.datasets.NewsClassification(root=download_location, download=False)
    ...
    for iteration in tqdm_bar:
        ...
        tqdm_bar.set_postfix(accuracy='{0:.4f}'.format(iteration_acc))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--download-location', type=str, default="../../data/task_data/text", metavar='S',
