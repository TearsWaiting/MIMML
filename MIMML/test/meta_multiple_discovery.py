...
def get_FPD_tasks(config):
    ...
    FPD_train_tasks = l2l.data.TaskDataset(
        ...
        task_transforms=[
            l2l.data.transforms.NWays(FPD_dataset_meta_train, n=config.test_way),
            l2l.data.transforms.KShots(FPD_dataset_meta_train, k=config.test_shot + config.test_query),
    ...
    # FPD_train_tasks = None
    FPD_valid_tasks = None
    FPD_test_tasks = None
